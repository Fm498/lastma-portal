...
MOCK_REPORTS = [
    {
        ...
        'media': [{'type': 'photo', 'url': 'https://pbs.twimg.com/media/HOdd_xYWUAAuyw6.jpg'}],
    },
    {
        ...
        'media': [{'type': 'video', 'url': 'https://video.twimg.com/amplify_video/2082721353937944576/vid/avc1/360x640/NoqBAtVjRiEfdx3s.mp4', 'poster': 'https://pbs.twimg.com/amplify_video_thumb/2082721353937944576/img/placeholder.jpg'}],
    },
    {
        ...
        'media': [{'type': 'video', 'url': 'https://video.twimg.com/amplify_video/2082719076061679616/vid/avc1/640x360/HjuSddngokAFfDgy.mp4'}],
    },
    {
        ...
        'media': [{'type': 'video', 'url': 'https://video.twimg.com/amplify_video/2082711749170446337/vid/avc1/480x864/20hDrfUKlDWNKRxw.mp4'}],
    },
    {
        ...
        'media': [{'type': 'video', 'url': 'https://video.twimg.com/amplify_video/2082699038420344832/vid/avc1/640x360/qrOVA0SdXO916P4G.mp4'}],
    },
    {
        ...
        'media': [{'type': 'video', 'url': 'https://video.twimg.com/amplify_video/2082681011880497152/vid/avc1/478x850/JSEbKt4v5Rq7v7lO.mp4'}, {'type': 'video', 'url': 'https://video.twimg.com/amplify_video/2082681042339520512/vid/avc1/478x850/1q-zQFxhlV-ZUt8U.mp4'}],
    },
    {
        ...
        'media': [{'type': 'video', 'url': 'https://video.twimg.com/amplify_video/2082494270401925120/vid/avc1/360x640/hJqLzYeSzOpdKP6m.mp4'}],
    },
    {
        ...
        'media': [{'type': 'video', 'url': 'https://video.twimg.com/amplify_video/2082488295091576832/vid/avc1/464x832/4t8Hz50A86wL-bJf.mp4'}],
    },
    {
        ...
        'media': [{'type': 'video', 'url': 'https://video.twimg.com/amplify_video/2082486916679602176/vid/avc1/360x640/GyRC7o41ffLoRh_k.mp4'}],
    },
    {
        ...
        'media': [{'type': 'video', 'url': 'https://video.twimg.com/ext_tw_video/2082478759844642816/pu/vid/avc1/368x656/yl6_1nEjvJ4XQAlP.mp4'}],
    },
    {
        'id': '2080992656709030197',
        'time': '13:20',
        'date': '2026-07-25',
        'timestamp': '2026-07-25T12:24:46Z',
        'location': 'NNPC Intersection',
        'area': 'Ejigbo / Isolo',
        'type': 'Breakdown',
        ...
        'lat': 6.551,
        'lng': 3.312,
        'url': 'https://x.com/followlastma/status/2080992656709030197',
        'media': [{'type': 'video', 'url': 'https://video.twimg.com/ext_tw_video/2080992619539173376/pu/vid/avc1/480x864/_HrQ3hy280xc9Asz.mp4'}],
    },
    {
        'id': '2080628967560593726',
        'time': '08:15',
        'date': '2026-07-24',
        'timestamp': '2026-07-24T07:15:00Z',
        'location': 'Kara Bridge – Lagos-Ibadan Expressway',
        'area': 'Berger / Ojodu',
        'type': 'Incident',
        ...
        'lat': 6.62,
        'lng': 3.34,
        'url': 'https://x.com/followlastma/status/2080628967560593726',
        'media': [],
    },
    {
        'id': '2079910941219545266',
        'time': '11:30',
        'date': '2026-07-22',
        'timestamp': '2026-07-22T10:30:00Z',
        'location': 'LASU–Isheri Road – Iyana School',
        'area': 'Igando',
        'type': 'Incident',
        ...
        'lat': 6.548,
        'lng': 3.255,
        'url': 'https://x.com/followlastma/status/2079910941219545266',
        'media': [],
    },
    {
        'id': '2079500000000000001',
        'time': '09:10',
        'date': '2026-07-21',
        'timestamp': '2026-07-21T08:10:00Z',
        'location': 'Third Mainland Bridge – Adekunle',
        'area': 'Lagos Island / Mainland',
        'type': 'Traffic Update',
        ...
        'lat': 6.5,
        'lng': 3.39,
        'url': 'https://x.com/followlastma/status/2079500000000000001',
        'media': [],
    },
    {
        'id': '2079200000000000002',
        'time': '17:45',
        'date': '2026-07-20',
        'timestamp': '2026-07-20T16:45:00Z',
        'location': 'Lekki–Epe Expressway – Sangotedo',
        'area': 'Lekki / Ajah',
        'type': 'Traffic Update',
        ...
        'lat': 6.447,
        'lng': 3.52,
        'url': 'https://x.com/followlastma/status/2079200000000000002',
        'media': [],
    },
    {
        'id': '2078900000000000003',
        'time': '07:20',
        'date': '2026-07-19',
        'timestamp': '2026-07-19T06:20:00Z',
        'location': 'Apapa–Oshodi Expressway – Mile 2',
        'area': 'Apapa / Oshodi',
        'type': 'Breakdown',
        ...
        'lat': 6.455,
        'lng': 3.32,
        'url': 'https://x.com/followlastma/status/2078900000000000003',
        'media': [{'type': 'photo', 'url': 'https://pbs.twimg.com/media/HOdd_xYWUAAuyw6.jpg'}],
    },
    {
        'id': '2078600000000000004',
        'time': '14:05',
        'date': '2026-07-18',
        'timestamp': '2026-07-18T13:05:00Z',
        'location': 'Ikeja – Allen Avenue / Opebi',
        'area': 'Ikeja',
        'type': 'Incident',
        ...
        'lat': 6.601,
        'lng': 3.351,
        'url': 'https://x.com/followlastma/status/2078600000000000004',
        'media': [],
    },
    {
        'id': '2078300000000000005',
        'time': '08:40',
        'date': '2026-07-17',
        'timestamp': '2026-07-17T07:40:00Z',
        'location': 'Gbagada – Olopomeji Bridge',
        'area': 'Gbagada',
        'type': 'Incident',
        ...
        'lat': 6.55,
        'lng': 3.39,
        'url': 'https://x.com/followlastma/status/2078300000000000005',
        'media': [{'type': 'photo', 'url': 'https://pbs.twimg.com/media/HOdd_xYWUAAuyw6.jpg'}],
    },
    {
        'id': '2078000000000000006',
        'time': '16:30',
        'date': '2026-07-16',
        'timestamp': '2026-07-16T15:30:00Z',
        'location': 'Maryland – Mobolaji Bank Anthony Way',
        'area': 'Maryland',
        'type': 'Traffic Update',
        ...
        'lat': 6.57,
        'lng': 3.37,
        'url': 'https://x.com/followlastma/status/2078000000000000006',
        'media': [],
    },
    {
        'id': '2077700000000000007',
        'time': '06:55',
        'date': '2026-07-15',
        'timestamp': '2026-07-15T05:55:00Z',
        'location': 'Badagry Expressway – Trade Fair',
        'area': 'Agbara / Badagry',
        'type': 'Breakdown',
        ...
        'lat': 6.47,
        'lng': 3.18,
        'url': 'https://x.com/followlastma/status/2077700000000000007',
        'media': [{'type': 'photo', 'url': 'https://pbs.twimg.com/media/HOdd_xYWUAAuyw6.jpg'}],
    },
    {
        'id': '2077400000000000008',
        'time': '12:15',
        'date': '2026-07-14',
        'timestamp': '2026-07-14T11:15:00Z',
        'location': 'Yaba – University Road',
        'area': 'Yaba',
        'type': 'Incident',
        ...
        'lat': 6.51,
        'lng': 3.38,
        'url': 'https://x.com/followlastma/status/2077400000000000008',
        'media': [],
    },
    {
        'id': '2077100000000000009',
        'time': '09:00',
        'date': '2026-07-13',
        'timestamp': '2026-07-13T08:00:00Z',
        'location': 'Alausa – Obafemi Awolowo Way',
        'area': 'Alausa / Ikeja',
        'type': 'Traffic Update',
        ...
        'lat': 6.62,
        'lng': 3.36,
        'url': 'https://x.com/followlastma/status/2077100000000000009',
        'media': [],
    },
    {
        'id': '2076800000000000010',
        'time': '18:20',
        'date': '2026-07-12',
        ...
        'lat': 6.447,
        'lng': 3.472,
        'url': 'https://x.com/followlastma/status/2076800000000000010',
        'media': [],
    },
    {
        'id': '2076500000000000011',
        'time': '07:45',
        'date': '2026-07-11',
        'timestamp': '2026-07-11T06:45:00Z',
        'location': 'Mushin – Agege Motor Road',
        'area': 'Mushin',
        'type': 'Incident',
        ...
        'lat': 6.53,
        'lng': 3.35,
        'url': 'https://x.com/followlastma/status/2076500000000000011',
        'media': [],
    },
    {
        'id': '2076200000000000012',
        'time': '15:10',
        'date': '2026-07-10',
        'timestamp': '2026-07-10T14:10:00Z',
        'location': 'CMS – Outer Marina',
        'area': 'Lagos Island',
        'type': 'Traffic Update',
        ...
        'lat': 6.45,
        'lng': 3.395,
        'url': 'https://x.com/followlastma/status/2076200000000000012',
        'media': [],
    },
    {
        'id': '2075900000000000013',
        'time': '08:25',
        'date': '2026-07-09',
        'timestamp': '2026-07-09T07:25:00Z',
        'location': 'Berger – Kara Bridge',
        'area': 'Berger / Ojodu',
        'type': 'Incident',
        ...
        'lat': 6.62,
        'lng': 3.34,
        'url': 'https://x.com/followlastma/status/2075900000000000013',
        'media': [{'type': 'photo', 'url': 'https://pbs.twimg.com/media/HOdd_xYWUAAuyw6.jpg'}],
    },
    {
        'id': '2075600000000000014',
        'time': '11:50',
        'date': '2026-07-08',
        'timestamp': '2026-07-08T10:50:00Z',
        'location': 'Ajah – Abraham Adesanya',
        'area': 'Lekki / Ajah',
        'type': 'Breakdown',
        ...
        'lat': 6.469,
        'lng': 3.569,
        'url': 'https://x.com/followlastma/status/2075600000000000014',
        'media': [{'type': 'photo', 'url': 'https://pbs.twimg.com/media/HOdd_xYWUAAuyw6.jpg'}],
    },
    {
        'id': '2075300000000000015',
        'time': '17:00',
        'date': '2026-07-07',
        'timestamp': '2026-07-07T16:00:00Z',
        'location': 'Oshodi – Bolade Intersection',
        'area': 'Oshodi',
        'type': 'Traffic Update',
        ...
        'lat': 6.555,
        'lng': 3.335,
        'url': 'https://x.com/followlastma/status/2075300000000000015',
        'media': [],
    },
    {
        'id': '2075000000000000016',
        'time': '06:30',
        'date': '2026-07-06',
        'timestamp': '2026-07-06T05:30:00Z',
        'location': 'Ikorodu Road – Mile 12',
        'area': 'Ikorodu',
        'type': 'Incident',
        ...
        'lat': 6.605,
        'lng': 3.4,
        'url': 'https://x.com/followlastma/status/2075000000000000016',
        'media': [{'type': 'photo', 'url': 'https://pbs.twimg.com/media/HOdd_xYWUAAuyw6.jpg'}],
    },
    {
        'id': '2074700000000000017',
        'time': '13:40',
        'date': '2026-07-05',
        ...
        'lat': 6.43,
        'lng': 3.42,
        'url': 'https://x.com/followlastma/status/2074700000000000017',
        'media': [],
    },
    {
        'id': '2074400000000000018',
        'time': '09:15',
        'date': '2026-07-04',
        ...
        'lat': 6.495,
        'lng': 3.36,
        'url': 'https://x.com/followlastma/status/2074400000000000018',
        'media': [],
    },
    {
        'id': '2074100000000000019',
        'time': '16:50',
        'date': '2026-07-03',
        'timestamp': '2026-07-03T15:50:00Z',
        'location': 'Agege Motor Road – Oshodi to Ikeja',
        'area': 'Agege / Ikeja',
        'type': 'Traffic Update',
        ...
        'lat': 6.58,
        'lng': 3.34,
        'url': 'https://x.com/followlastma/status/2074100000000000019',
        'media': [{'type': 'photo', 'url': 'https://pbs.twimg.com/media/HOdd_xYWUAAuyw6.jpg'}],
    },
    {
        'id': '2073800000000000020',
        'time': '07:05',
        'date': '2026-07-02',
        'timestamp': '2026-07-02T06:05:00Z',
        'location': 'Apapa Port Access – Wharf Road',
        'area': 'Apapa',
        'type': 'Incident',
        ...
        'lat': 6.447,
        'lng': 3.365,
        'url': 'https://x.com/followlastma/status/2073800000000000020',
        'media': [{'type': 'photo', 'url': 'https://pbs.twimg.com/media/HOdd_xYWUAAuyw6.jpg'}],
    },
    {
        'id': '2073500000000000021',
        'time': '10:30',
        'date': '2026-07-01',
        'timestamp': '2026-07-01T09:30:00Z',
        'location': 'Ikeja – Computer Village axis',
        'area': 'Ikeja',
        'type': 'Breakdown',
        ...
        'lat': 6.595,
        'lng': 3.345,
        'url': 'https://x.com/followlastma/status/2073500000000000021',
        'media': [],
    },
]
...
def _parse_post(tweet: dict, media_lookup: dict | None = None) -> dict:
    ...
    for key in (tweet.get("attachments") or {}).get("media_keys") or []:
        ...
        if mtype == "photo":
            ...
            url = mp4s[0]["url"] if mp4s else m.get("url")
            poster = m.get("preview_image_url")
            if url:
...
async def fetch_live_reports() -> list[dict]:
    ...
    params = {
        ...
        "media.fields": "type,url,preview_image_url,variants,media_key",
    }
    ...
    async with httpx.AsyncClient(timeout=20.0) as client:
        ...
        media_lookup = {m["media_key"]: m for m in media_list if "media_key" in m}
        return [_parse_post(t, media_lookup) for t in tweets]
